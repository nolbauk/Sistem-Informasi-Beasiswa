        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body"><br>
                    <form class="row g-3" action="{{ route('prestasicreate') }}" method="POST">
                    @csrf
                    <div class="col-12">
                        ...
                        <select id="id_calon" class="form-control" name="id_calon">
                            ...
                            @foreach ($data_calon as $row)
                                <option value="{{ $row->id }}">{{ $row->nama_calon }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="jenis_prestasi" name="jenis_prestasi">
                    </div>
                    <div class="col-12">
                        <label for="tanggal_prestasi" class="form-label">Tanggal Prestasi</label>
                        <input type="text" class="form-control" id="tanggal_prestasi" name="tanggal_prestasi">
                    </div>
