...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <a href="{{ route('hasilcreate') }}" class="btn btn-primary">Create Data</a>
        <a href="{{ route('hasilreport') }}" target="_blank" class="btn btn-danger">Cetak Data</a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <a href="{{ route('hasiledit', $row->id) }}" class="btn icon btn-success">Edit</a>
                                        <a href="{{ route('hasildelete', $row->id) }}" class="btn icon btn-danger"onclick="return confirm('Apakah anda yakin menghapus data ini?')">Delete</a>
                                    </td>
                            </tr>
                            @endforeach
                            @else
