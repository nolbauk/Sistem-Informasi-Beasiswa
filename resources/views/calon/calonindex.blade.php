...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header">
            <h2 style="text-align: center;">Calon Penerima Beasiswa</h2>
        ...
        <a href="{{ route('caloncreate') }}" class="btn btn-primary">Create Data</a>
        <a href="{{ route('calonreport') }}" target="_blank" class="btn btn-danger">Cetak Data</a>
            <table class='table datatable table-striped table-bordered' id="table1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                    <td style="text-align: center;">{{ $row->nama_calon}}</td>
                                    ...
                                    <td style="text-align: center;">{{ $row->nilai_tes}}</td>
                                    <td style="text-align: center;">
                                        <a href="{{ route('calonedit', $row->id) }}" class="btn icon btn-success">Edit</a>
                                        <a href="{{ route('calondelete', $row->id) }}" class="btn icon btn-danger"onclick="return confirm('Apakah anda yakin menghapus data ini?')">Delete</a>
                                    </td>
                            </tr>
                            @endforeach
                            @else
